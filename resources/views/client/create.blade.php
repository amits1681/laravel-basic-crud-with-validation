...
<div class="container">
	<div class="row">
	   ...
	   <div class="col-md-12">
	    ...
	    {{ Form::open(array('url' => 'clients/store', 'method' => 'post','class'=>'form-horizontal',  'files' => true)) }}
			<fieldset>
			...
			<div class="form-group">
			  ...
			  <div class="radio">
			    <label for="client-status-0">
			      <input type="radio" name="status" id="client-status-0" value="active" checked="checked">
			      Active
			    </label>
				</div>
			  <div class="radio">
			    <label for="client-status-1">
			      <input type="radio" name="status" id="client-status-1" value="inactive">
			      Inactive
			    </label>
				</div>
			  </div>
